...
public class Serial_Main {
	...
	public static void main(String[] args) {
		...
		try {
			ivyHandler = new IvyHandler("Serial Handler", new IvyCallBack(), "");
		}
		catch  (Exception ie) {
			ie.printStackTrace();
		}
			...
			switch (packetSize) {
            	case 6:  
            		...
            		if (radarPacket[6] == 19 && radarPacket[7] == 20 ){
    					...
    					data = String.valueOf("DATA " + System.currentTimeMillis()) + " " +  chan1 + " " + chan2;   					
    				}
    				else
    					findHeaderStart();
            		break;
            	...
            	case 4:
            		...
            		if (in.read() == 19 && in.read() == 20) {
            			data = "TEST " + String.valueOf(System.currentTimeMillis()) + " " +  test;   					
    				}
            		else
            			findHeaderStart();
            	...
            	case 12:
            		...
            		if (in.read() == 19 && in.read() == 20) {
            			data = "GPS_VEL " + String.valueOf(System.currentTimeMillis()) + " " +  gspeed + " " + z_dot + " " + heading;   					
    				}
            		else
            			findHeaderStart();
            	...
            	case 16:
            		...
            		if (in.read() == 19 && in.read() == 20) {
            			data = "GPS_POS " + String.valueOf(System.currentTimeMillis()) + " " +  lon + " " + lat + " " + hMSL + " " + hAcc;   					
    				}
            		else
            			findHeaderStart();
	...
	private static void fakeData() {
		...
		while (true){
			...
			String data = String.valueOf("DATA " + System.currentTimeMillis()) + " " +  chan1 + " " + chan2;
			ivyHandler.send(data);
